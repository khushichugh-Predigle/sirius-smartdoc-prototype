...
(function () {
  ...
  // Shared across the app now — see data/providers-data.js. Kept as a local
  // const so every existing reference in this file stays unchanged.
  const CPR_PRESCRIBERS = window.PROVIDERS;
